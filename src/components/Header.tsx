...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-16 md:h-18 bg-white/[0.03] backdrop-blur-2xl border-b border-white/10 px-4 md:px-6 flex items-center justify-between z-30 sticky top-0 select-none">
      ...
      <div className="flex items-center gap-2 md:gap-4 truncate">
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 md:px-3.5 md:py-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-medium text-slate-200 transition-all shadow-sm cursor-pointer"
          >
            ...
            <span className="font-semibold text-white max-w-[100px] sm:max-w-[150px] md:max-w-[200px] truncate">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5">
        ...
        {/* Virtual Remote Control Trigger */}
        <button
        ...
        <button
          ...
          className="w-9 h-9 sm:w-10 sm:h-10 bg-white/5 hover:bg-white/10 rounded-full flex items-center justify-center border border-white/10 text-slate-300 hover:text-white transition-colors cursor-pointer"
          title="Plein écran (F)"
        >
